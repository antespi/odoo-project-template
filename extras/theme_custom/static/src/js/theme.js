...
if (typeof jQuery === 'undefined') { throw new Error('Theme requires jQuery') }

// Check jQuery UI available
// if (typeof jQuery.ui === 'undefined') { throw new Error('Theme requires jQuery UI') }

// Check Bootstrap JS plugins available
// if (typeof jQuery.fn.alert === 'undefined') { throw new Error('Theme requires Bootstrap Alert plugin') }

// Check Backbone available
// if (typeof Backbone === 'undefined') { throw new Error('Theme requires Backbone') }
